using { sameer_2_a38Srv } from '../srv/service.cds';

annotate sameer_2_a38Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate sameer_2_a38Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate sameer_2_a38Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate sameer_2_a38Srv.CustomerMessage with @UI.DataPoint #titleEnglish: {
  Value: titleEnglish,
  Title: 'Title (English)',
};
annotate sameer_2_a38Srv.CustomerMessage with @UI.DataPoint #customerName: {
  Value: customerName,
  Title: 'Customer Name',
};
annotate sameer_2_a38Srv.CustomerMessage with @UI.DataPoint #productName: {
  Value: productName,
  Title: 'Product Name',
};
annotate sameer_2_a38Srv.CustomerMessage with {
...
annotate sameer_2_a38Srv.CustomerMessage with @UI.LineItem: [
...
annotate sameer_2_a38Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate sameer_2_a38Srv.CustomerMessage with @UI.HeaderFacets: [
...
annotate sameer_2_a38Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate sameer_2_a38Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
